      ...
      >
        ...
        <List>
          <Link to={'/'} style={{ textDecoration: 'none' }}> 
            <ListItem disablePadding>
              <ListItemButton sx={{ color: `${location.pathname === "/" ? "#6DFF59" : "white"}`,backgroundColor: `${location.pathname === "/" ? "#72AAFF" : "none"}`}}>
        ...
        <List>
          <Link to={'/schedule'} style={{ textDecoration: 'none' }}> 
            <ListItem disablePadding>
              <ListItemButton sx={{ color: `${location.pathname === "/schedule" ? "#6DFF59" : "white"}`,backgroundColor: `${location.pathname === "/schedule" ? "#72AAFF" : "none"}`}}>
        ...
        <List>
          <Link to={'/medic'} style={{ textDecoration: 'none' }}> 
            <ListItem disablePadding>
              <ListItemButton sx={{ color: `${location.pathname === "/medic" ? "#6DFF59" : "white"}`,backgroundColor: `${location.pathname === "/medic " ? "#72AAFF" : "none"}`}}>
